...
export function WorldMap({ nodes, onOpen }: Props) {
  ...
  return (
    <Card className="p-3 sm:p-4">
      ...
      <div
        className="relative w-full overflow-hidden rounded-md border border-border/60 bg-[hsl(30_16%_11%)]"
    ...
    series: [
      {
        ...
        selectedMode: false,
        itemStyle: {
          areaColor: 'rgba(184,166,132,0.14)',
          borderColor: 'rgba(192,172,140,0.30)',
          borderWidth: 0.4,
        },
        emphasis: {
          label: { show: false },
          itemStyle: { areaColor: '#bd6338' },
        },
        label: { show: false },
        data,
        markPoint: {
        ...
        <div className="flex items-center gap-2 px-3 py-2.5 border-b border-border/70">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[11px] text-muted-foreground font-mono mt-0.5">
              <span className="text-good">{entry.online} 在线</span>
